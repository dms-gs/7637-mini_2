...
#    test_agent.solve(initial_arrangement_1, initial_arrangement_1)
...
#    test_agent.solve(initial_arrangement_1, goal_arrangement_2)
    print(test_agent.solve(initial_arrangement_1, goal_arrangement_3))
#    test_agent.solve(initial_arrangement_1, goal_arrangement_3)
    print(test_agent.solve(initial_arrangement_1, goal_arrangement_4))
#    test_agent.solve(initial_arrangement_1, goal_arrangement_4)
